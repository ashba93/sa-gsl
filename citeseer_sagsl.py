...
def train():
    dataset = Dataset("citeseer", n_splits=1, split="random", cv=5)#,split_params="train_examples_per_class")
    ...
    optim = torch.optim.Adam(list(gnn.parameters()), lr=5e-2, weight_decay=1e-2)
